...
describe("calculateAIScore", () => {
  ...
  it("得分应随检测到的模式数单调递增", () => {
    const few = calculateAIScore(detectAIPatterns("This is a landmark moment."))
...
describe("isAIText", () => {
  it("默认阈值 50 下，明显的 AI 文本应被判为 AI", () => {
    const aiText =
      "Additionally, this is groundbreaking. Furthermore, it serves as a milestone. I hope this helps."
