      ...
      {activeTab === "qa" ? (
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <CopilotPanel
            ...
            setSelectedAsrProvider={setSelectedAsrProvider}
            ...
            lastReportPromptRef={lastReportPromptRef}
            ...
            resetReportContext={resetReportContext}
            cancelSession={agent.cancelSession}
            outlineNodes={outline.nodes}
            outlineSelectedNodeId={outline.selectedNodeId}
            onInsertToCursor={(text) => {
