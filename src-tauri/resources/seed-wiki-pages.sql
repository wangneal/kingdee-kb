...
-- 清空已有数据
DELETE FROM wiki_pages WHERE project = '__PROJECT__';

-- ======== Summary 页面（1-10）========
INSERT INTO wiki_pages (project, slug, title, page_type, content, wikilinks, tags, page_metadata, page_status) VALUES
